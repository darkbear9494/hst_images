...
outPtNm = 'PG1302-102_f110w_sky'

image = mfm.loadFits(inPtImg, 0) #Load image from FITS file
cirlist = mfm.load_DS9_Reg(inPtReg)


img_msk, img_mskd, img_msk_rgn, img_mskd_rgn = mfm.sky_Mask_Region(image, mskScal=5, seThrsh=3, minArea=5)
img_msk, img_mskd, img_msk_rgn, img_mskd_rgn = mfm.sky_Mask_Region(image, inPtMsk=img_msk, mskScal=30, MskRgn=(250, 750, 270, 770))
